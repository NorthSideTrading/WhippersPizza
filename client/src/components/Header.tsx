...
const Header = () => {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-white z-[999] md:hidden">
            ...
            <div className="flex-1 flex flex-col justify-center px-6">
              <ul className="space-y-6">
                <li>
                  <Link 
                    href="/" 
                    className={`flex items-center py-4 px-4 text-xl font-medium rounded-lg transition-colors ${location === '/' ? 'bg-[hsl(5,65%,40%)] text-white' : 'text-[hsl(212,40%,18%)] hover:bg-gray-100'}`}
                    onClick={toggleMenu}
                  >
                ...
                <li>
                  <Link 
                    href="/menu" 
                    className={`flex items-center py-4 px-4 text-xl font-medium rounded-lg transition-colors ${location === '/menu' ? 'bg-[hsl(5,65%,40%)] text-white' : 'text-[hsl(212,40%,18%)] hover:bg-gray-100'}`}
                    onClick={toggleMenu}
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                ...
                <li>
                  <Link 
                    href="/gallery" 
                    className={`flex items-center py-4 px-4 text-xl font-medium rounded-lg transition-colors ${location === '/gallery' ? 'bg-[hsl(5,65%,40%)] text-white' : 'text-[hsl(212,40%,18%)] hover:bg-gray-100'}`}
                    onClick={toggleMenu}
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                ...
                <li>
                  <Link 
                    href="/about" 
                    className={`flex items-center py-4 px-4 text-xl font-medium rounded-lg transition-colors ${location === '/about' ? 'bg-[hsl(5,65%,40%)] text-white' : 'text-[hsl(212,40%,18%)] hover:bg-gray-100'}`}
                    onClick={toggleMenu}
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                ...
                <li className="pt-4">
                  <a 
                    href="tel:+12076221471" 
                    className="flex items-center justify-center py-4 px-6 bg-[hsl(5,65%,40%)] text-white font-semibold rounded-lg text-xl"
                    onClick={toggleMenu}
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
